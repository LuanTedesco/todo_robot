  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Priority" do
        expect {
          post priorities_url, params: { priority: valid_attributes }
        }.to change(Priority, :count).by(1)
      end

      it "redirects to the created priority" do
        post priorities_url, params: { priority: valid_attributes }
        expect(response).to redirect_to(priority_url(Priority.last))
      end
    end
    ...
    context "with invalid parameters" do
      it "does not create a new Priority" do
        expect {
          post priorities_url, params: { priority: invalid_attributes }
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested priority" do
        priority = Priority.create! valid_attributes
        patch priority_url(priority), params: { priority: new_attributes }
        priority.reload
      ...
      it "redirects to the priority" do
        ...
        patch priority_url(priority), params: { priority: new_attributes }
        priority.reload
        expect(response).to redirect_to(priority_url(priority))
      end
    end
    ...
    context "with invalid parameters" do
      ...
      it "renders a response with 422 status (i.e. to display the 'edit' template)" do
        priority = Priority.create! valid_attributes
        patch priority_url(priority), params: { priority: invalid_attributes }
        expect(response).to have_http_status(:unprocessable_entity)
      end
